...
public class PinHelper {
    ...
    public void setRegistrationLockPin(
        ...
        } else if (backupResponse instanceof final SecureValueRecovery.BackupResponse.ApplicationError error) {
            throw new IOException(error.getException());
        } else if (backupResponse instanceof final SecureValueRecovery.BackupResponse.NetworkError error) {
